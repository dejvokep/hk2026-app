...
export default function Page() {
    ...
    if (!completed) {
        if (share)
            return <ShareStage receipt={receipt} group={selectedGroupId} onCompleteAction={complete}/>
